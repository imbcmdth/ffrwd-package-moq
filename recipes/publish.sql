...
-- variables: source (input media path), relay (relay URL, host by IP), broadcast (broadcast path), cert (a private relay's certificate, DER as hex; leave unset for a public relay)
