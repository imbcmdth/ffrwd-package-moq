...
-- variables: source (live input URL), relay (relay URL, host by IP), broadcast (broadcast path), cert (a private relay's certificate, DER as hex; leave unset for a public relay)
